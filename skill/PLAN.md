...
后续技能内容、关系数据、检索和接口代码统一放在 `skill/` 下，随着实际功能建立必要子目录。

截至本次整理：

- 已完成：项目资料目录、六份候选资料的审核清单、研究与实施规划。
- 等待人工处理：书籍审核、下载和优先章节确认。
- 待实施：原文提炼、技能验证、接口接入、向量检索、关系图扩展与对照实验。

下一步：审核 S01、S02 或中文备选 S04，将通过审核的原书放入 `skill/books/`，记录实际版本与优先章节，再提炼第一批 Support 技能。
